          ...
          <div className="signal-dialog" role="dialog" aria-modal="true" aria-labelledby="signal-dialog-title" onMouseDown={(event) => event.stopPropagation()}>
            ...
            {dialogAction === 'course-change' && (
              <div className="signal-course-fields">
                ...
                <label className="signal-dialog__field"><span>新方位（真方位・任意・0〜359°T）</span><input type="number" min="0" max="359" step="1" value={newBearing} onChange={(event) => setNewBearing(event.target.value)} placeholder="例: 015" /></label>
