/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.worker.jsonc` (hash: 7099994b43f43cdd74f37c25d669fe85)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	BACKUP_SIGNING_PRIVATE_KEY: string;
	EVENT_ROOMS: DurableObjectNamespace<import("./worker/index").EventRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKUP_SIGNING_PRIVATE_KEY">> {}
}
