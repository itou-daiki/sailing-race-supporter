...
const WORLD_SAILING_PRESETS: readonly CoursePreset[] = [
  {
    ...
    description: '1→2→3の外側ループを使う標準コースです。記号の2は風上レグの回数を示します。',
  ...
  },
  {
    ...
    name: 'トラペゾイド・インナーループ',
    shortName: 'インナー',
    optionLabel: 'トラペゾイド（I2）— インナー・風上レグ2回',
    description: '1→4→1の内側ループを使うコースです。記号の2は風上レグの回数を示します。',
    codeMeaning: 'I = Inner（インナー）／2 = 風上レグ2回',
    route: ['Start', '1', '4S/4P', '1', '2', '3P', 'Finish'],
    initialMarkKeys: ['start-pin', 'start-rc', 'mark-1', 'mark-4s', 'mark-4p', 'mark-2', 'mark-3p', 'finish-mark', 'finish-boat'],
    tags: ['トラペゾイド', 'インナー', '内側ゲート'],
    sourceLabel: 'World Sailing標準例',
  },
  {
    code: 'L2',
    ...
    initialMarkKeys: ['start-pin', 'start-rc', 'mark-1', 'mark-4s', 'mark-4p', 'finish-mark', 'finish-boat'],
    tags: ['風上／風下', '2周', '風下ゲート'],
    sourceLabel: 'World Sailing標準例',
  },
  {
  ...
  },
  {
    ...
    initialMarkKeys: ['start-pin', 'start-rc', 'mark-1', 'mark-2', 'mark-3', 'finish-mark', 'finish-boat'],
...
const SNIPE_PRESETS: readonly CoursePreset[] = [
  {
    ...
    initialMarkKeys: ['start-pin', 'start-rc', 'mark-1', 'mark-1a', 'mark-3s', 'mark-3p', 'finish-mark', 'finish-boat'],
