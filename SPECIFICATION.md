...
16.5の初期推奨値を採用する。すなわち、確定・監査記録5年、風・潮流等1年、D1の間引き位置90日、高頻度ローカル航跡7日、通常メッセージ・添付90日、名前・担当1年、招待・復元コード30日、セキュリティログ1年とする。保存ホールドと大会管理者による版付き変更を認める。
